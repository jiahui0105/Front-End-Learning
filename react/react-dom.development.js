...
function setInitialProperties$1(domElement, tag, rawProps, rootContainerElement) {
  var isCustomComponentTag = isCustomComponent(tag, rawProps);
  {
    ...
    if (isCustomComponentTag && !didWarnShadyDOM && domElement.shadyRoot) {
      warning_1(false, '%s is using shady DOM. Using shady DOM with React can ' + 'cause things to break subtly.', getCurrentFiberOwnerName$2() || 'A components');
...

{
  ...
  ReactStrictModeWarnings.flushPendingDeprecationWarnings = function () {
    if (pendingComponentWillMountWarnings.length > 0) {
      ...
      lowPriorityWarning$1(false, 'componentWillMount is deprecated and will be removed in the next major version. ' + 'Use componentDidMount instead. As a temporary workaround, ' + 'you can rename to UNSAFE_componentWillMount.' + '\n\nPlease update the following components: %s' + '\n\nLearn more about this warning here:' + '\nhttps://fb.me/react-async-components-lifecycle-hooks', sortedNames);
    ...
    if (pendingComponentWillReceivePropsWarnings.length > 0) {
      ...
      lowPriorityWarning$1(false, 'componentWillReceiveProps is deprecated and will be removed in the next major version. ' + 'Use static getDerivedStateFromProps instead.' + '\n\nPlease update the following components: %s' + '\n\nLearn more about this warning here:' + '\nhttps://fb.me/react-async-components-lifecycle-hooks', _sortedNames);
    ...
    if (pendingComponentWillUpdateWarnings.length > 0) {
      ...
      lowPriorityWarning$1(false, 'componentWillUpdate is deprecated and will be removed in the next major version. ' + 'Use componentDidUpdate instead. As a temporary workaround, ' + 'you can rename to UNSAFE_componentWillUpdate.' + '\n\nPlease update the following components: %s' + '\n\nLearn more about this warning here:' + '\nhttps://fb.me/react-async-components-lifecycle-hooks', _sortedNames2);
  ...
  ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = function (fiber, instance) {
    ...
    if (strictRoot === null) {
      warning_1(false, 'Expected to find a StrictMode components in a strict mode tree. ' + 'This error is likely caused by a bug in React. Please file an issue.');
      return;
    }

    // Dedup strategy: Warn once per components.
    // This is difficult to track any other way since components names
...
/**
 * The "actual" render time is total time required to render the descendants of a Profiler components.
...
function checkClassInstance(workInProgress) {
  ...
  var type = workInProgress.type;
  {
    ...
    !(instance.props === undefined || !hasMutatedProps) ? warning_1(false, '%s(...): When calling super() in `%s`, make sure to pass ' + "up the same props that your components's constructor was passed.", name, name) : void 0;
    ...
    if (typeof instance.getSnapshotBeforeUpdate === 'function' && typeof instance.componentDidUpdate !== 'function' && !didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate.has(type)) {
      ...
      warning_1(false, '%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). ' + 'This components defines getSnapshotBeforeUpdate() only.', getComponentName(workInProgress));
    }
    ...
    if (typeof ctor.getDerivedStateFromProps === 'function' || typeof instance.getSnapshotBeforeUpdate === 'function') {
      ...
      if (foundWillMountName !== null || foundWillReceivePropsName !== null || foundWillUpdateName !== null) {
        ...
        if (!didWarnAboutLegacyLifecyclesAndDerivedState.has(_componentName)) {
          ...
          warning_1(false, 'Unsafe legacy lifecycles will not be called for components using new components APIs.\n\n' + '%s uses %s but also contains the following legacy lifecycles:%s%s%s\n\n' + 'The above lifecycles should be removed. Learn more about this warning here:\n' + 'https://fb.me/react-async-components-lifecycle-hooks', _componentName, newApiName, foundWillMountName !== null ? '\n  ' + foundWillMountName : '', foundWillReceivePropsName !== null ? '\n  ' + foundWillReceivePropsName : '', foundWillUpdateName !== null ? '\n  ' + foundWillUpdateName : '');
        }
      }
    }
  }
...
function callComponentWillMount(workInProgress, instance) {
  ...
  if (oldState !== instance.state) {
    {
      warning_1(false, '%s.componentWillMount(): Assigning directly to this.state is ' + "deprecated (except inside a components's " + 'constructor). Use setState instead.', getComponentName(workInProgress) || 'Component');
    }
...
function updateHostComponent(current, workInProgress, renderExpirationTime) {
  ...
  if (hasContextChanged()) {
    ...
    if (isHidden) {
      // Before bailing out, make sure we've deprioritized a hidden components.
...
function mountIndeterminateComponent(current, workInProgress, renderExpirationTime) {
  ...
  if (typeof value === 'object' && value !== null && typeof value.render === 'function' && value.$$typeof === undefined) {
    ...
    workInProgress.tag = FunctionalComponent;
    {
      ...
      if (_Component) {
        !!_Component.childContextTypes ? warning_1(false, '%s(...): childContextTypes cannot be defined on a functional components.', _Component.displayName || _Component.name || 'Component') : void 0;
      }
...

{
  ...
  warnAboutUpdateOnUnmounted = function (fiber) {
    ...
    warning_1(false, "Can't call setState (or forceUpdate) on an unmounted components. This " + 'is a no-op, but it indicates a memory leak in your application. To ' + 'fix, cancel all subscriptions and asynchronous tasks in the ' + 'componentWillUnmount method.%s', getStackAddendumByWorkInProgressFiber(fiber));
